			...
			<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
              ...
              if(ctype_digit($_GET["sayfa"])){
                ...
                $sayfa=1;
							...
							<a href="izle.php?url=<?php echo $bolum["url"]; ?>" class="hvr-shutter-out-horizontal"><img src="resim.php?url=<?php echo base64_encode($bolum["resim"]); ?>" title="<?php echo $bolum[$i]["isim"]; ?>" class="img-responsive" alt=" " />
						  ...
						  <ul class="pagination justify-content-end">
						    <?php
								...
								for ($i=1; $i <= $yenieklenenler[1]["max"] ; $i++) {
									if( ($sayfa==$i) || ($i==$yenieklenenler[1]["bulunan"])){
